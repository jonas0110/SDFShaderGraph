...
EZ.EMesh.prototype.setExtraUniforms = function (shader) {
    ...
    for (var i in shader.globals) {
        ...
        //if(shader.globals[i].name == "u_camera_pos")
           //console.log(unis[shader.globals[i].name]);
    }
...
EZ.Renderer.prototype = {
    ...
    // method from rendeer
    render: function (scene, camera,cameraInside) {
        ...
        //camera的pos和target都变了但是不更新Matrix 2020.5.3
